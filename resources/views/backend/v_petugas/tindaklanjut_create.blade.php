...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="row">
            <div class="col-12">
                <div class="card-body">
                    <form action="{{ route('backend.petugas.tindaklanjut.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <a href="{{ route('backend.petugas.tindaklanjut') }}" class="btn btn-secondary">Kembali</a>
                    </form>
                </div>
            </div>
        </div>
