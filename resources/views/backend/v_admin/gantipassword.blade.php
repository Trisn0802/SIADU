...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form action="{{ route('backend.admin.updatepassword', $edit->uuid) }}" method="post" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    <div class="card-body">
                    ...
                    <div class="border-top">
                        <div class="card-body">
                            ...
                            <a href="{{ route('backend.admin.edit', $edit->uuid) }}" class="btn btn-secondary">Kembali</a>
                        </div>
                    </div>
                </form>
            </div>
