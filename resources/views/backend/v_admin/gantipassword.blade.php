...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form action="{{ route('backend.admin.updatepassword', $edit->id_user) }}" method="post" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    <div class="card-body">
                    ...
                    <div class="border-top">
                        <div class="card-body">
                            ...
                            <a href="{{ route('backend.admin.edit', ['id' => $edit->id_user]) }}" class="btn btn-secondary">Kembali</a>
                        </div>
                    </div>
                </form>
            </div>
