<!DOCTYPE html>
    ...
    <head>
        ...
        <title>SIADU - Ganti Password Admin</title>
        ...
        <div class="auth-container">
            <div class="auth-card">
                ...
                <div class="auth-body">
                    ...
                    <div class="info-box">
                        <strong>👤 Pengguna: {{ $user->nama }}</strong> (Admin)<br>
                        Masukkan password lama dan password baru Anda di bawah ini.
                    </div>

                    <form action="{{ route('backend.admin.updatepassword', ['uuid' => $user->uuid]) }}" method="POST">
                        @csrf
                        @method('PUT')
