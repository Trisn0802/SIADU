    ...
    <div class="auth-container">
        <div class="auth-card">
            ...
            <div class="auth-body">
                ...
                <div class="info-box">
                    <strong>👤 Pengguna: {{ auth()->user()->nama }}</strong><br>
                ...
                @php
                    ...
                    $routeName = match($user->role) {
                        1 => 'password.change.process.admin',
                        2 => 'password.change.process.petugas',
                        default => 'password.change.process'
                    };
                @endphp
                ...
                <form action="{{ route($routeName, ['uuid' => $user->uuid]) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="password-input-wrapper">
                            <input
                                ...
                                required
                            >
                            <i class="bi bi-eye password-icon" onclick="togglePassword('password_lama')"></i>
                        </div>
                        @error('password_lama')
                    ...
                    <div class="form-group">
                        ...
                        <div class="password-input-wrapper">
                            ...
                            >
                            <i class="bi bi-eye password-icon" onclick="togglePassword('password_baru')"></i>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="password-input-wrapper">
                            <input
                                ...
                                required
                            >
                            <i class="bi bi-eye password-icon" onclick="togglePassword('password_baru_confirmation')"></i>
                        </div>
                    </div>
